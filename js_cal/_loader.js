...
var c_name1="lang_mail";var templang="";
if (document.cookie.length>0)
  ...
  if (c_start1!=-1)
    ...
    templang= unescape(document.cookie.substring(c_start1,c_end1));
    }
  }


if(templang=="eng" || templang=="")
js('defaults1.js');
else if(templang=="spa")
js('defaults2.js');
else if(templang=="fre")
js('defaults3.js');
else
js('defaults1.js');
js('main.js');
