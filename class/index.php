...
/**
  ...
  **/
	...
	{
		if ((preg_match('#.csv#mi',$file)) && (filemtime($dir."/".$file)) < (strtotime('yesterday'))) 
		{
			$del=@unlink($dir."/".$file);
		}
	}
	  ...
	  <tr>
	    ...
	    <td>	
	      <select name="domain" size="1">
			<option value="gmail.com" <?php if ($usrdomain=="gmail.com") {
        echo \SELECTED;
    } ?>>gmail</option>
			<option value="hotmail.com" <?php if ($usrdomain=="hotmail.com") {
        echo \SELECTED;
    } ?>>hotmail</option>
			<option value="rediff.com" <?php if ($usrdomain=="rediff.com") {
        echo \SELECTED;
    } ?>>rediff</option>		
			<option value="yahoo.com" <?php if ($usrdomain=="yahoo.com") {
        echo \SELECTED;
    } ?>>yahoo</option>
			<option value="orkut.com" <?php if ($usrdomain=="orkut.com") {
        echo \SELECTED;
    } ?>>orkut</option>			
			<option value="myspace.com" <?php if ($usrdomain=="myspace.com") {
        echo \SELECTED;
    } ?>>myspace</option>
			<option value="indiatimes.com" <?php if ($usrdomain=="indiatimes.com") {
        echo \SELECTED;
    } ?>>indiatimes</option>
			<option value="linkedin.com" <?php if ($usrdomain=="linkedin.com") {
        echo \SELECTED;
    } ?>>linkedin</option>
			<option value="aol.com" <?php if ($usrdomain=="aol.com") {
        echo \SELECTED;
    } ?>>aol</option>
			<option value="lycos.com" <?php if ($usrdomain=="lycos.com") {
        echo \SELECTED;
    } ?>>lycos</option>
		  </select>
	        </td>
	...
	if(isset($_POST['submit']) && !empty($_POST['submit'])) 
	{
		...
		require(__DIR__ . "/baseclass/baseclass.php");
		if($usrdomain=="aol.com")
	    {
		     require(__DIR__ . "/aol/aol.class.php");
			 $obj = new grabAol($YOUR_EMAIL,$YOUR_PASSWORD);
	    }
	         
        if($usrdomain=="lycos.com")
        {
		     require(__DIR__ . "/lycos/lycos.class.php");
			 $obj = new grabLycos($YOUR_EMAIL,$YOUR_PASSWORD);
        }
		
		if($usrdomain=="indiatimes.com")
	    {
		     require(__DIR__ . "/indiatimes/grabIndiatimes.class.php");
			 $obj = new indiatimes();
	    }
	         
	    if($usrdomain=="linkedin.com")
	    {
		     require(__DIR__ . "/linkedin/grabLinkedin.class.php");
			 $obj = new linkedin();
	    }
	         
		if($usrdomain=="rediff.com")
	    {
		     require(__DIR__ . "/rediff/grabRediff.class.php");
			 $obj = new rediff();
        }
	
	    if($usrdomain=="gmail.com")
	    {
		     require(__DIR__ . "/gmail/libgmailer.php");
	    ...
	    {
	         require(__DIR__ . "/orkut/grabOrkut.class.php");
	         $obj = new orkut();
	    }
	
	    if($usrdomain=="myspace.com")
	    {
	         require(__DIR__ . "/myspace/grabMyspace.class.php");
			 $obj = new myspace();
    	}
		
		if($usrdomain=="yahoo.com")
	    {
        	require(__DIR__ . "/yahoo/class.GrabYahoo.php");
	 		$obj = new GrabYahoo();
	    ...
	    {
        	require(__DIR__ . "/hotmail/msn_contact_grab.class.php");
	 		$YOUR_EMAIL = $_POST['username']."@".$usrdomain;
	 		$obj = new hotmail();
	    }
