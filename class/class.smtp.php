...
class SMTP {
  ...
  public function Authenticate($username, $password) {
    ...
    fwrite($this->smtp_conn, base64_encode((string) $username) . $this->CRLF);
    ...
    fwrite($this->smtp_conn, base64_encode((string) $password) . $this->CRLF);
  ...
  public function Data($msg_data) {
    ...
    foreach ($lines as $line) {
        ...
        foreach ($lines_out as $line_out) {
            if(strlen($line_out) > 0 && str_starts_with($line_out, "."))
            {
              $line_out = "." . $line_out;
            }
