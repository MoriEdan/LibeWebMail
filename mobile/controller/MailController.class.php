...
function getattachmentdetailsAction()
{
	...
	while($row=$db->fetchRow($result))
	{
		...
		$filename=$row[0];$ftype=base64_encode((string) $row[1]);
...
function downloadattachmentAction()
{
	$username=$_COOKIE['e_username'];
				...
				$ftype=$this->getParam(4);$ftype=base64_decode((string) $ftype);
                ...
                } elseif ($ftype1[1]=='mp3' || $ftype1[1]=='amr' || $ftype1[1]=='wma' || $ftype1[1]=='wav' || $ftype1[1]=='3ga' || $ftype1[1]=='mid' || $ftype1[1]=='midi') {
                    $newftype="audio/$ftype1[1]";
                } elseif ($ftype1[1]=='mp4' || $ftype1[1]=='3gp' || $ftype1[1]=='mpeg' || $ftype1[1]=='mpg' || $ftype1[1]=='mpeg-4' || $ftype1[1]=='wmv' || $ftype1[1]=='avi') {
